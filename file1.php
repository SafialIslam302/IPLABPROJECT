...
<?php
	...
	if(isset($_POST['submit'])){
		...
		if($name && $doc_name){
			...
			$query = mysql_query("INSERT INTO tbl4 (name,cname,path) VALUES ('$doc_name','$cname','$location')");
		}
		else
		{
			$error = 10;
...
<?php
	include ("dbcon.php");
	$sql = "SELECT * FROM tbl4 where cname='$cname' ";
	$res = mysql_query($sql);
?>
...
<body>
    ...
    <form action="file1.php" method="post" enctype="multipart/form-data" style="padding-left: 0%;">
		<h1>
	...
	<?php
		...
		while($row = mysql_fetch_array($res)){
			...
			echo "<td><a href='delete3.php?del=$path'> DELETE </a><br></td>"; 
			echo "</tr>";		
 		}
 		echo "</table>";
